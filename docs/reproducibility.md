...
- QW-CTC uses fixed read weights derived from offline reference-alignment confidence.
...
Raw data and pseudo-labels must be obtained or generated externally before running these scripts.
